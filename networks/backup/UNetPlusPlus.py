...
#         # print('stck input_channels=', input_feature_channels)
#         # print('stck output_channels=', output_feature_channels)
...
#                                                                   basic_block, transpconv)
#         # print('encoder features=',encoder_features3)
...
#         # skips = []
#         seg_outputs = []
#         # print(self.conv_blocks_context[1])
