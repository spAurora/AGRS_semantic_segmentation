...
for model_index in range(len(model_names)):
    ...
    trainListRoot = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\2-trainlist\9-trainlist_clear+real_cloud_230426.txt' # 训练样本列表
    save_model_path = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\3-weights' # 训练模型保存路径  
    model = used_models[model_index] # 选择的训练模型
    save_model_name = '9-' + model_names[model_index] + '-huyang_clear+real_cloud_240426.th' # 训练模型保存名
