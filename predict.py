...
if __name__ == '__main__':
    ...
    trainListRoot = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\2-trainlist\3-trainlist_clear_mix_sim_haze_ATSC+convw+pn_LV2_rate_0.1_230424.txt' #与模型训练相同的训练列表路径
    num_class = 3 # 样本类别数
    model = Unet #模型
    model_path = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\3-weights\3-Unet-huyang_clear_mix_sim_haze_ATSC+convw+pn_LV2_rate_0.1_230424.th' # 模型文件完整路径
    output_path = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\3-predict_result\3-predict_result_Unet-huyang_clear_mix_sim_haze_ATSC+convw+pn_LV2_rate_0.1_230424' # 输出的预测结果路径
