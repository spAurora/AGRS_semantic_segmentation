...
'''参数设置'''
trainListRoot = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\2-trainlist\3-trainlist_clear_mix_sim_haze_ATSC_LV1_rate_0.2_230425.txt' # 训练样本列表
save_model_path = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\3-weights' # 训练模型保存路径  
model = UNet # 选择的训练模型
save_model_name = '4-UNet-clear_mix_sim_haze_ATSC_LV1_rate_0.2_230501.th' # 训练模型保存名
...
test_img_path = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\1-clip_img\1-clip_img_haze_lv1' # 测试集影像文件夹
test_label_path = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\1-raster_label\1-raster_label_haze_lv1' # 测试集真值标签文件夹
