...
if __name__ == '__main__':
    ...
    trainListRoot = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\2-trainlist\9-trainlist_clear+real_cloud_240426.txt' #与模型训练相同的训练列表路径
    num_class = 3 # 样本类别数
    model = UNetFormer #模型
    model_path = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\3-weights\9-UNetFormer-huyang_clear+real_cloud_240426.th' # 模型文件完整路径
    output_path = r'E:\xinjiang_huyang_hongliu\Huyang_test_0808\3-predict_result\predict_UNetFormer-huyang_clear+real_cloud_240426' # 输出的预测结果路径
