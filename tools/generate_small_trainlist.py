...
input_file_path = r'E:\project_global_populus\MAE_test_250324\2-train_list\trainlist-250324.txt'
output_file_path = r'E:\project_global_populus\MAE_test_250324\2-train_list\trainlist-250324_' + str(retain_percentage) + '.txt'
