...
FQ_NAME_LIST = ['Algeria', 'Azerbaijan Kazakhstan','India','lran','lrag','lsrael','Libya','Mongolia','Morocco','Pakistan','Tajikistan','Tunisia','Turkey','Turkmenistan','Uzbekistan','XJ_Aletai','XJ_hami','XJ_Tacheng','XJ_WuchangTulufan']


for fq_name in FQ_NAME_LIST:
    print(fq_name)

    image_path = r'I:\PROJECT_GLOBAL_POPULUS_DATA_02\FQ-' + fq_name +'\SELECT_IMG'
    image_type = '*.img'
    mosaic_line_full_path = r'I:\PROJECT_GLOBAL_POPULUS_DATA_02\FQ-' + fq_name + '\MOSAIC-LINE\MOSAIC-LINE.shp' # 镶嵌线文件绝对路径，注意镶嵌线文件其实是个polygon
    ouput_path = r'I:\PROJECT_GLOBAL_POPULUS_DATA_02\FQ-' + fq_name +'\MASK'
