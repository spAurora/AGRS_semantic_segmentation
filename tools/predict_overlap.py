...
if __name__ == '__main__':
    ...
    predictImgPath = r'E:\UAV_yunnan\烟株识别测试数据202210\3channel\temp' # 待预测影像的文件夹路径
    Img_type = '*.tif' # 待预测影像的类型
    trainListRoot = r'E:\projict_UAV_yunnan\2-trainlist\trainlist_1024_1.txt' #与模型训练相同的trainlist
    numclass = 2 # 样本类别数
    model = DLinkNet34 #模型
    model_path = r'E:\projict_UAV_yunnan\3-weights\DLinkNet34-UAV_yunnan_yancao_1024.th' # 模型文件完整路径
